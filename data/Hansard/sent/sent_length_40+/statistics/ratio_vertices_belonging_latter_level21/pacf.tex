...
\path [draw=color0, semithick]
(axis cs:1,0)
--(axis cs:1,0.698392726485698);

\path [draw=color0, semithick]
(axis cs:2,0)
--(axis cs:2,0.0180649104469604);

\path [draw=color0, semithick]
(axis cs:3,0)
--(axis cs:3,-0.114581317014485);

\path [draw=color0, semithick]
(axis cs:4,0)
--(axis cs:4,0.128498075557533);

\path [draw=color0, semithick]
(axis cs:5,0)
--(axis cs:5,-0.85848283539984);
